...
# ------------------- ANIMACAO BLOCO DE INTERROGACAO -------------------
# ------------------- BLOCOS DE INTERROGACAO -------------------
iInterrogacao:
	#COR A SER ALTERADA: LARANJA ($12)
	addi $15, $0, 0 #quantidade de iteracoes
...
ultimaLinha:
	...
	j ultimaLinha
fimUltimaLinha:
	beq $15, 0, iCorLaranja
	beq $15, 1, iCorMarromClaro
	beq $15, 2, iCorMarromEscuro
	beq $15, 3, iCorMarromClaro
	j iCorLaranja
	
iCorLaranja:
	addi $12, $0, 0
	ori $12, 0xe79c21
	beq $15, 4, resetarControleDeCores
	j seguirComOPisca
