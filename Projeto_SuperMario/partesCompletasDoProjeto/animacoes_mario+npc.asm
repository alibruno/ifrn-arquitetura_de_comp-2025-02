...
verificarColisao:
# Original: 51496 -> Novo Offset: 52520
lw $19, 52520($8)
beq $19, $12, gameOver
beq $19, $13, gameOver
beq $19, $14, gameOver

# Original: 52520 -> Novo Offset: 53544
lw $19, 53544($8)
beq $19, $12, gameOver
beq $19, $13, gameOver
beq $19, $14, gameOver

# Original: 53544 -> Novo Offset: 54568
lw $19, 54568($8)
beq $19, $12, gameOver
beq $19, $13, gameOver
beq $19, $14, gameOver

# Original: 54568 -> Novo Offset: 55592
lw $19, 55592($8)
beq $19, $12, gameOver
beq $19, $13, gameOver
beq $19, $14, gameOver
...
# Original: 55636 -> Novo Offset: 56660
lw $19, 56660($8)
beq $19, $12, gameOver
beq $19, $13, gameOver
beq $19, $14, gameOver

# Original: 56660 -> Novo Offset: 57684
lw $19, 57684($8)
beq $19, $12, gameOver
beq $19, $13, gameOver
beq $19, $14, gameOver
...
# Original: 52564 -> Novo Offset: 53588
lw $19, 53588($8)
beq $19, $12, gameOver
beq $19, $13, gameOver
beq $19, $14, gameOver

# Original: 53588 -> Novo Offset: 54612
lw $19, 54612($8)
beq $19, $12, gameOver
beq $19, $13, gameOver
beq $19, $14, gameOver
